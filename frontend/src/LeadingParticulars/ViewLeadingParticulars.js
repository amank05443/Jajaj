    ...
    {/*--------------------------------------------------------------------- First row ---------------------------------------------------*/}
                        <Grid size={12}>
                            <table border="1" cellPadding="2" style={{width:'100%' ,fontSize:'15px'}} >
                                <tbody>
                                    <tr >
                                         <td> <FaPlane /> &nbsp;Aircraft Type : <b style= {{color: 'green'}}>{aircraftDetails.ac_type||'NA'}</b></td>
                                         <td> <FaPlane /> &nbsp; Aircraft Mark &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;<b style= {{color: 'green'}}> {aircraftDetails.aircraft_mark||'NA'} </b></td>
                                         <td> <FaPlane /> &nbsp; Airframe Serial No &nbsp;&nbsp;&nbsp;: <b style= {{color: 'green'}}><i>{aircraftDetails.side_no||'NA'}</i></b></td>
                                         <td> <FaGlobeAsia /> Aircraft Primary / Secondary Role &nbsp;&nbsp;&nbsp; : <b style= {{color: 'green'}}>{aircraftDetails.roles||'NA'}</b></td>
                                    </tr>
                                </tbody>
                            </table>
                        </Grid>
                                    ...
                                    <Grid container spacing= {2}>
                                        <Grid  size={7}>
                                            <table border="1" cellPadding="6" style={{width:'100%'}} >
                                                <thead>
                                                    <tr>
                                                        <th colspan={5} style={{background:'#FFD5E0'}}><FaCogs /> Engine / E.C.U. Details </th>
                                                    </tr>
                                                    <tr >
                                                       <th >Description</th>
                                                       <th >Type</th>
