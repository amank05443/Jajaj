...
const USLogForm = () => {
  ...
  const { data: howFound, loading: loadingHowFound } =
    useTableApi("how_found_defects");
  const { data: entryType, loading: loadingEntryTypes } =
    useTableApi("entry_types");
  const { data: aircraftMasters, loading: loadingMasters } = useTableApi(
    "aircraft_masters",
