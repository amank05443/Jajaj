...
{/*           ist */}
        <div className=" flex-1 grid grid-cols-1 md:grid-cols-4 gap-6 mb-2  ">
          <div className="md:col-span-3">
            <Card
              className="!bg-gradient-to-r from-gray-800 to-indigo-600 shadow-2xl  !rounded-2xl border border-indigo-500
...
{/*             </div> */}
              <div className="mb-8 group cursor-pointer"
                onMouseEnter={()=> setHoveredCard("flying")}
                onMouseLeave={()=> setHoveredCard(null)}
                onclick={()=> setActiveCard(activeCard==="flying" ? null : "flying")(null)}>
               <div className={`relative overflow-hidden rounded-3xl transition-all duration-700 ${hoveredCard === "flying" ? "transform scale-[1.02]-translate-y-2" : ""}`}>
                   <div className="absolute inset-0.5 bg-gradiant-to-r from-red-500 via-blue-500 to-cyan-500  rounded-3xl opacity-0 transition-opacity duration-700 blur-sm"></div>
                   <div className="relative backdrop-blur-xl  bg-gradiant-to-br from-cyan-500/10 via-blue-600/10 to-cyan-500/5 rounded-3xl p-8 border border-white/20  ">
{/*                    shimmer and accent */}
                        <div className={`absolute inset-0 shimmer ${hoveredCard === "flying" ? "opacity-100" :"opacity-0"} transition-opacity`}></div>
                        <div className="absolute top-0 right-0 w-32 h-32  bg-gradiant-to-br from-cyan-400/20 to-transparent rounded-bl-full "></div>
                       <div className="relative flex items-center justify-between">
                           <div className="flex items-center gap-6">
                               <div className={`relative transition-all duration-700 ${hoveredCard === "flying" ? "scale-110 rotate-12 ": ""}`}>
                                   <div className="absolute inset-0 bg-gradiant-to-br from-cyan-400  to-cyan-600 rounded-full blur-2xl opacity-60 animate-pulse"></div>
                                   <div className=" relative w-28 h-28 rounded-full bg-red-400   flex items-center justify-center  ">
                                   <div className={`absolute -inset-4 border-2 border-cyan-400/30 rounded-full transition-all duration-1000 ${hoveredCard === "flying" ? "scale-150 opacity-0" : ""}`}></div>
                                   <div className={`absolute -inset-2 border  border-cyan-300/50 rounded-full transition-all duration-700 ${hoveredCard === "flying" ? "scale-125 opacity-0" : ""}`} style ={{animationDelay:"0.2s"}}></div>
                                       ...
                                       <div className="relative">
                                           ...
                                           <div>
                                           <h2 className="text-xl text-white"> wfhewiufgh</h2>
        ...
        <Card
          className=" flex-1 !bg-gradient-to-r from-gray-800 to-indigo-600 shadow-2xl  !rounded-2xl border border-indigo-500  hover:shadow-[0_0_25px_rgba(255,255,255,0.3)]
                         transition-all duration-300"
        >
          <CardContent className=" !p-2">
            ...
            <div className=" flex  justify-between text-white  ">
              ...
              <div>
                <Card
                  className="  flex items-center justify-center pr-4 pl-4  p-2 !bg-gradient-to-r from-blue-600 via-green-700 to-yellow-600   shadow-2xl
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
              <Card
                className="!bg-gradient-to-br from-gray-800 to-blue-700  shadow-2xl  !rounded-2xl border border-blue-500 !backdrop-blur-lg
              ...
              <Card
                className="!bg-gradient-to-br from-teal-700 to-blue-900 shadow-2xl  !rounded-2xl border border-indigo-500 !backdrop-blur-lg
                 hover:shadow-[0_0_25px_rgba(255,255,255,0.3)]
                 transition-all duration-300 "
              >
                <CardContent className="flex flex-col   p-6 h-48">
              ...
              <Card
                className="!bg-gradient-to-br from-cyan-800 to-purple-600  shadow-2xl  !rounded-2xl border border-purple-500 !backdrop-blur-lg
                    hover:shadow-[0_0_25px_rgba(255,255,255,0.3)]
                    transition-all duration-300"
              >
                <CardContent className="flex flex-col   p-6 h-48">
