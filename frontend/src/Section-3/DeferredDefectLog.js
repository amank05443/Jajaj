        ...
        <div style={{padding:20}}>
            <Paper elevation={4} sx={{p:2,mt:2,mb:4,borderRadius:4,border:'4px solid #64b5f6',background:'linear-gradient(to right,#e3f2fd,#bbdefb)',}}>
                <Typography variant="h4" align="center" gutterBottom sx={{fontWeight:'900',color:'#0d47a1',letterSpacing:3,}}>
                    Acceptable Deferred Defects Log
                </Typography>
                <Typography sx={{textAlign:'right'}}>
                    <sub style={{fontSize:'1rem'}}><u>MOD Form 704</u></sub>
                </Typography>
            </Paper>
            <Button variant="contained" color="primary" onClick={() => navigate('/NewEntryForDeferredDefectLog')}>
                New Entry
            </Button>
                ...
                <Table>
                    <TableHead>
                        <TableRow sx={{ backgroundColor:'#1976d2'}}>
                            ...
                            <TableCell sx={{color:'#fff',fontWeight:'bold'}}>Trade</TableCell>
                            <TableCell sx={{color:'#fff',fontWeight:'bold'}}>SNOW</TableCell>
                            <TableCell sx={{color:'#fff',fontWeight:'bold'}}>A/F Hrs</TableCell>
                            <TableCell sx={{color:'#fff',fontWeight:'bold'}}>Deferred Defect Details</TableCell>
                    ...
                    <TableBody>
                            <TableRow>
                                ...
                                <TableCell>1227</TableCell>
                                <TableCell>142:15</TableCell>
                            ...
                            <TableRow>
                                ...
                                <TableCell>141:15</TableCell>
                                <TableCell>Minor leak detected</TableCell>
                                <TableCell>
                                    <Tooltip title='Clear U/S'>
                                        <Button variant="contained" size="small">
                                           Continue
...
export default DeferredDefectLog;