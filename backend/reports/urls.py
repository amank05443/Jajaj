...
from .views import MODForm703
from .views import MODForm704
...
urlpatterns = [
    ...
    path("handlePrintMODForm703/pdf/<int:id>/", MODForm703, name="MODForm703"),
    path("handlePrintMODForm704/pdf/<int:id>/", MODForm704, name="MODForm704"),
