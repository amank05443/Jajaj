...
urlpatterns = [
    ...
    # path('api/user/<str:pno>/',views.get_user_profile),
    # path('api/user/set_password/',views.save_user_profile),
    # path('api/check_user/', views.check_user_by_pno),
    # path('api/submit_user/', views.submit_user_data),
