...
from .views import AircraftDetailView, aircraft_all_detail_view, Quals_view
...
urlpatterns = [
    ...
    path('api/aircraftSideNo/', AircraftDetailView.as_view(), name='AircraftDetailView'),
    path('api/qualsData', Quals_view.as_view(), name='AircraftDetailView'),
    path('api/leadingParticularsOfAircraft/<int:side_no>/', views.aircraft_all_detail_view, name='AircraftDetailView'),
