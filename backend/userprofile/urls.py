...
from userprofile.views import (login_view, get_csrf_token, user_profile_view,get_customers, logout_view, register_view, create_rank,
                               create_qual,list_quals, AircraftDetailView)
from . import views
