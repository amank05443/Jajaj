...
class ChangeOfServiceabilityLogs(models.Model):
    ...
    authorised_by = models.ForeignKey('UserQuals', models.DO_NOTHING, related_name='changeofserviceabilitylogs_authorised_by_set', blank=True, null=True)
    ...
    supervisor = models.ForeignKey('UserQuals', models.DO_NOTHING, related_name='changeofserviceabilitylogs_supervisor_set', blank=True, null=True)
