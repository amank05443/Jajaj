...
class Users(models.Model):
    ...
    rank_id = models.DecimalField(max_digits=64,decimal_places=0,null=True, blank=True)
    customer_id = models.DecimalField(max_digits=64,decimal_places=0,null=True, blank=True)
    login_pwd = models.CharField(max_length=50,null=True, blank=True)
