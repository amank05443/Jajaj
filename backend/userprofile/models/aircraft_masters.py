...
class AircraftMasters(models.Model):
    ...
    date_of_expiry_of_ttl = models.DateField(blank=True, null=True)
    ...
    max_operating_gg_load = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
