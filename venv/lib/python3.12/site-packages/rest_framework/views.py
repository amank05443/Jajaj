...
class APIView(View):
    ...
    def jasper_report_user_list(request):
    #Paths
input_file = os.path.join(settings.BASE_DIR,'reports', 'user_list.jasper')
output_file = os.path.join(settings.MEDIA_ROOT, 'user_list')
